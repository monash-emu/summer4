...
>
> - [x] `examples/notebooks/07-targets.ipynb` — the fit converges to the known
>   parameters, and the memory saving is shown as a number rather than asserted
>   in prose.
> - [x] `docs/user/10-targets-and-fitting.ipynb` — dated series, sparse fit,
>   weekly resample / `at_times` reporting story reads as a modeller would write.
